...
coarse_train = dict(
    ...
    weight_entropy_last=0.01,      # weight of background entropy loss ## from 0.01 - 0.1
...
coarse_model_and_render = dict(
    num_voxels=128**3,           # expected number of voxel
    num_voxels_base=128**3,      # to rescale delta distance
    ...
    rgbnet_width=16,              # width of the colors MLP
